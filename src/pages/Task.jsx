...
const App = () => {
  ...
  return (
    ...
    <div className=' w-full flex flex-col items-center gap-2 bg-gray-200  dark:bg-black '>
        ...
        <div className='w-full flex justify-evenly'>
          ...
          <div className='w-[70%]'>
            <div className="inputs flex flex-col gap-5">
              <input className=' dark:text-white border-2 border-gray-800 focus:border-red-500 focus:shadow-lg focus:shadow-red-300 outline-none transition duration-300 p-2 rounded-md text-lg' 
                type="text" 
                id="taskInput" 
      ...
      <div className='w-[70%] flex flex-col gap-3' dark:bg-black>
        {tasks.length === 0 ? (<p className='text-gray-500 text-center'>No tasks available</p>) : (tasks.map((element, index) => (
                <div key={index}>
                    <div className='border-2 flex flex-col p-3 rounded-lg shadow-sm bg-white'>
